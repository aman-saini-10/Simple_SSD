...
for cmt in "65568"; do
    output_folder="/home/waqar/MappingTableWork/mappingWrokStats/hcftl/DeadLRUVsLRU/predictorThrreshold/Shadow1_$cmt"
    ...
    for input_file in $input_files; do
        ...
        #sed -i 's/size_t cmtSize = [0-9]\+;/size_t cmtSize = 604;/' simplessd/icl/global_point.cc
        ...
        sed -i '89s/\(bool usePortionOfCacheAsShadow *= *\)\(false\)/\1true/' simplessd/icl/global_point.cc
